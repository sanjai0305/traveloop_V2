...
const App = () => {
  ...
  const [showSplash, setShowSplash] = React.useState(isNative);
  ...
  useEffect(() => {
    if (!isNative) return;
    const timer = setTimeout(() => setShowSplash(false), 1850);
  ...
  }, [showSplash, isNative]); // eslint-disable-line react-hooks/exhaustive-deps
