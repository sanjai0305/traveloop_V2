...
from app.models.analytics import AnalyticsFilters
from app.models.demand import DemandsResponse
...
router = APIRouter(prefix="/demands", tags=["Demand Intelligence", "Dashboard"])


@router.get(
    "",
    response_model=DemandsResponse,
    summary="Get travel demand intelligence for admin dashboards",
)
async def get_demands(
    ...
    await rate_limiter.check(f"rate:demands:{client_host}")
    ...
    return await service.get_demands(filters)
