      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 lg:p-8">
          ...
          <motion.div
            ...
            style={{ maxWidth }}
            className={`relative w-full w-[95vw] sm:w-[90vw] lg:w-[min(1000px,90vw)] max-h-[90vh] bg-white dark:bg-slate-900 rounded-[20px] sm:rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden z-10 ${className}`}
            role="dialog"
            aria-modal="true"
